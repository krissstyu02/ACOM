...
#все что вхходит красным, все что не входит черным-делаем меньший диапазон
while True:
    ret, frame = cap.read()
    ...
    lower_red = np.array([0, 100, 100])  # Минимальные значения оттенка, насыщенности и яркости
    upper_red = np.array([11, 255, 255])  # Максимальные значения оттенка, насыщенности и яркости
